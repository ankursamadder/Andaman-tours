...
const reasons = [
  ...
  {
    title: "Real activity details, no surprises",
    desc: "Every activity shows the exact step-by-step flow, inclusions and exclusions before you enquire - nothing hidden.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    desc: "Combine activities, add extras, or swap sessions - send your shortlist and we'll tailor it for you.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  return (
    <section id="why-us" className="bg-lagoon-700 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 lg:py-24">
        ...
        <h2 className="font-display text-3xl sm:text-4xl max-w-xl text-balance">Planned like locals, priced like an activity desk</h2>
