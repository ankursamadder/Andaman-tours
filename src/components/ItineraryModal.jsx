...
export default function ItineraryModal({ pkg, onClose, onEnquire }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-6">
      ...
      <div className="relative bg-sand-50 w-full sm:max-w-5xl sm:rounded-3xl rounded-t-3xl max-h-[92vh] overflow-y-auto shadow-2xl">
        <div className="relative h-56 sm:h-64">
          ...
          <div className="absolute bottom-4 left-6 right-6">
            ...
            <p className="text-sand-100/90 text-sm mt-1">
            ...
            <div>
              <div className="flex flex-wrap gap-2 mb-8">
                {pkg.highlights.map((h) => (
                  <span
                    key={h}
                    className="text-xs bg-lagoon-50 text-lagoon-700 border border-lagoon-100 px-3 py-1.5 rounded-full"
                  >
                    {h}
                  </span>
                ))}
